...
#previous_rank_null = f500[null_bool]
...
japanese_employers=f500[f500["country"]=="Japan"].sort_values("employees",ascending = False)
top_japanese_employer = japanese_employers.iloc[0,0]
...
for c in countries:
    sorted_rows = f500[f500["country"]==c].sort_values("employees",ascending=False)
...
for s in sector_unique:
    sorted_row = f500[f500["sector"]== s].sort_values("roa",ascending =False)
    top_roa_by_sector[s]=sorted_row.iloc[0]["company"]