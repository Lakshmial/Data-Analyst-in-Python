...
for keys in content_ratings:
    content_ratings[keys]/=total_number_of_apps
    content_ratings[keys]*=100
...
for keys in content_ratings:
    proportion=content_ratings[keys]/total_number_of_apps
    c_ratings_proportions[keys]=proportion
...
data_sizes=[]
for each_row in apps_data[1:]:
    data_sizes.append(float(each_row[2]))
